...
spectrum_tensor_train, scatter_tensor_train, lifetime_tensor1_train, lifetime_tensor2_train, size_tensor_train, spectrum_tensor_valid, scatter_tensor_valid, lifetime_tensor1_valid, lifetime_tensor2_valid, size_tensor_valid, y_norm_train, y_norm_valid = load_datasets('../data/novi_sad_2019_/', "./Libraries/HIRST_2019021601_2019101706.xlsx")
